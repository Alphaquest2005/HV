...
namespace RMSDataAccessLayer
{
    ...
    public partial class QBCustomer : BaseEntity<QBCustomer>
    {
        ...
        public QBCustomer()
        {
            this.QBSales = new ObservableCollection<QBSale>();
            CustomStartup();
            CustomStartup2();
        ...
        partial void CustomStartup2();
            ...
            ChangeTrackingCollection<QBCustomer> _changeTracker;
            [NotMapped]
            [IgnoreDataMember]
            public ChangeTrackingCollection<QBCustomer> ChangeTracker
            {
                get
                {
            ...
            {
                _changeTracker = new ChangeTrackingCollection<QBCustomer>(this);
            }
        [DataMember]
        ...
        [DataMember]
    	public ObservableCollection<QBSale> QBSales
    	{
    		get { return _QBSales; }
    		set
    		{
    			if (Equals(value, _QBSales)) return;
    			_QBSales = value;
    			NotifyPropertyChanged();
    		}
    	}
    	private ObservableCollection<QBSale> _QBSales;
    }
}
